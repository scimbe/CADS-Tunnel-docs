...
| `--green` | Push straight through to the Grün tier (your own certificate) as part of setup, instead of stopping at Gelb. See [Go from Gelb to Grün]({{ '/how-to/gelb-to-gruen/' | relative_url }}) if you'd rather do this as a separate step later. |
